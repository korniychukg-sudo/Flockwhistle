...
enum Field {
    static let paper      = Tone(r: 0.925, g: 0.906, b: 0.855)
    static let paperWarm  = Tone(r: 0.945, g: 0.925, b: 0.867)
    static let paperCool  = Tone(r: 0.894, g: 0.898, b: 0.878)
    static let canvas     = Tone(r: 0.878, g: 0.847, b: 0.769)

    static let ink        = Tone(r: 0.110, g: 0.114, b: 0.106)
    static let inkSoft    = Tone(r: 0.239, g: 0.247, b: 0.231)
    static let inkPale    = Tone(r: 0.427, g: 0.435, b: 0.416)
    static let sepia      = Tone(r: 0.333, g: 0.263, b: 0.180)

    static let turf       = Tone(r: 0.463, g: 0.529, b: 0.353)
    static let turfDark   = Tone(r: 0.322, g: 0.396, b: 0.263)
    static let turfPale   = Tone(r: 0.612, g: 0.647, b: 0.451)
    static let bracken    = Tone(r: 0.639, g: 0.478, b: 0.267)
    static let heather    = Tone(r: 0.518, g: 0.404, b: 0.475)
    static let moor       = Tone(r: 0.451, g: 0.451, b: 0.353)
    static let stone      = Tone(r: 0.612, g: 0.600, b: 0.569)
    static let stoneDark  = Tone(r: 0.400, g: 0.392, b: 0.376)
    static let slate      = Tone(r: 0.325, g: 0.353, b: 0.376)
    static let sky        = Tone(r: 0.729, g: 0.784, b: 0.816)
    static let skyLow     = Tone(r: 0.855, g: 0.847, b: 0.816)
    static let fleece     = Tone(r: 0.878, g: 0.867, b: 0.831)
    static let fleeceDark = Tone(r: 0.694, g: 0.678, b: 0.639)
    static let collie     = Tone(r: 0.161, g: 0.153, b: 0.145)
    static let oat        = Tone(r: 0.847, g: 0.792, b: 0.667)
    static let rust       = Tone(r: 0.588, g: 0.318, b: 0.196)
    static let oxblood    = Tone(r: 0.529, g: 0.208, b: 0.169)
    static let brass      = Tone(r: 0.749, g: 0.596, b: 0.290)
    static let bone       = Tone(r: 0.875, g: 0.851, b: 0.788)
    static let night      = Tone(r: 0.098, g: 0.106, b: 0.114)
    static let water      = Tone(r: 0.416, g: 0.514, b: 0.541)
}
