...
@MainActor
final class FlockLaunchGate: ObservableObject {
    ...
    private func attempt(_ n: Int) {
        ...
        let tracker = FlockGateTracker(checkDomain: checkDomain, ownHost: ownHost)
...
final class FlockGateTracker: NSObject, URLSessionTaskDelegate {
    var onProgress: (() -> Void)?
